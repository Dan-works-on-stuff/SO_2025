...
int main(int argc, char *argv[])
{
	...
	/* Notă: putem renunța la a mai specifica flagul O_TRUNC în apelul open() de mai sus, deoarece oricum
             urmează să trunchiem fișierul la dimensiunea necesară, în apelul ftruncate() de mai jos. */
    ...
    // sa te fut ba petter griffin, ca scrii cod cu picioarele
