...
int main(int argc, char *argv[], char *env[]) {
    ...
    /* Afișăm PID-ul, PPID-ul, UID-ul, linia de comandă și environment-ul pentru instanța curentă. */
    ...
    printf("Urmeaza apelul primitivei execve...");
    /* Astfel, acest text va fi scris cu culoarea roșie pe fundal alb. */
